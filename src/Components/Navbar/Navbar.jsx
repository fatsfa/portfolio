...
const Navbar = () => {
  ...
  return (
    <div className='navbar'>
     ...
     <li><AnchorLink className='anchor-link' offset={50} href='#work'><p onClick={()=>{setMenu('portfolio'); closeMenu()}}>Portfolio</p></AnchorLink>{menu==="portfolio"?<img src={underline} alt= ''/>:<></>}</li>
